...
func _play_review_set() -> void:
	var specs: Array[Dictionary] = [
		...
		{"key": "vfx.callout.capture", "position": [3, 11], "priority": "high", "group": "callout", "late": "replace_group", "side": "red"},
		{"key": "vfx.bombardment.resolve", "position": [7, 14], "priority": "high", "group": "bombardment", "late": "play_once", "side": "black"},
		{"key": "vfx.resurrection.revive", "position": [6, 16], "priority": "high", "group": "resurrection", "late": "play_once", "side": "red"},
