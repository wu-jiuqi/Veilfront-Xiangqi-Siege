...
| 车 | 可沿同一直线路径穿过敌棋并按起点到终点顺序逐目标处理：实际死亡先登记到所属方公开阵亡记录，随后立即检查该目标是否为将帅；不触发任何被动士替死。车不可穿过己棋。普通车在路径中途首次接触未显形的敌方隐身马时，吃掉该马并停在接触交点，不得让隐身马造成无反馈的行动失败。若路径目标将帅实际死亡，立即终局并停止后续目标。特殊车该次从起点到终点的完整路径形成视野，持续到此车下一次移动开始。 |
...
- 占领进度绑定具体棋子，不可换子继承。占领者离开、死亡、主动献祭、复活流程导致占领实例离场、强制撤回或棋子实例变化时立即清零。
