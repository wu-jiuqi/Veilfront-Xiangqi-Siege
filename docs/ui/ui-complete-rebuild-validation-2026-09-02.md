...
正式生产路径中的设置、关卡选择、正式局域网大厅、加载页、对局 HUD、教程、图鉴、暂停、引导、标记菜单、确认框和终局面板已经统一到“玄铁军帐 / 兵书军令”视觉系统。开始菜单按项目所有者要求恢复并锁定为原版，不参与本轮改造。布局由预置 `Control` / `Container` 节点与带有效九宫格边距的可缩放 Theme 表面承担，不依赖固定尺寸整页贴图确定控件位置。
...
- 视觉基础：统一玄铁、旧青铜、玉色、朱砂、暖象牙五色语义，碑刻标题字体、间距、按钮家族和九类表面角色。
